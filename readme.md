...
Files and scripts used for strain classification and reference database construction based on:
- Public complete genomes from NCBI
- Representative genomes from EnteroBase
- Isolates sequenced in this study
- These resources were used to define strain-level relationships and construct the strain-level reference database employed for strain tracking in metagenomic samples.
